        ...
        <header>
            <div class="banner row no-margin">
                <div class="container content">
                    <h1><?= $CFG->exchange_name; ?> - <?php echo isset($pgcont['home_heading_key']) ? $pgcont['home_heading_key'] : "Kuwait's Leading Digital Exchange"; ?></h1>
                   ...
                   { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="banner-images">
                                <a href="api-docs" target="_blank" rel="nofollow"><img src="sonance/img/banner/3.png"></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="banner-images">
